...
public class UserController : ControllerBase
{
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    public async Task<ActionResult<UserUpdateDTO>> Update([FromRoute] string id,
        [FromBody] UserPatchPasswordDTO? userPatchPasswordDto)
    {
        ...
        User? user = await _userService.PatchPassword(userPatchPasswordDto.OldPassword!,
            userPatchPasswordDto.NewPassword!, Ulid.Parse(id));
